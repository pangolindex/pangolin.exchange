<script>
  ...
  const socials = [
    ...
    {
      name: "Substack",
      href: "https://pangolin.substack.com/",
              ...
              <div class="overflow-hidden rounded-lg ring-1 ring-black ring-opacity-5 shadow-lg">
                <div class="grid relative gap-6 py-6 px-5 bg-white sm:gap-8 sm:p-8">
                  ...
                  >
                    ...
                    <div class="ml-4">
                      <p class="text-base font-medium text-gray-900">Pangolin V2</p>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <div class="mt-6">
            <nav class="grid gap-y-8">
              ...
              >
                ...
                <span class="ml-3 text-base font-medium text-gray-900">Pangolin V2</span>
              </a>
            </nav>
          </div>
        </div>
